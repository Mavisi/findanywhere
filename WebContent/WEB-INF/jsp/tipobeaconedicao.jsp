...
<body>
    ...
    <section>
        <div class="container mt-4">
            <a href="<c:url value="tipobeacon"/>">🡰 Voltar</a>
            <div class="mt-2 col-md-6 mx-auto" id="cadastro">
                <div class="card card-body">
                    
                    <h4 class="h5 text-center">Edição de Tipo de Beacon</h4>
                    
                    <form method="post" action="<c:url value="tipobeacon?acao=edicao"/>">
    
                        <input type="hidden" name="id" value="${tipoBeacon.id}">
                        
                        <div class="form-group">
                            <label for="descricao">Descrição</label>
                            <input class="form-control" type="text" name="descricao" required="required" value="${tipoBeacon.descricao}">    
                        </div>
    
                        <div class="form-group">
                            <label for="layout">Layout</label>
                            <input class="form-control" type="text" name="layout" required="required" value="${tipoBeacon.layout}">    
                        </div>
