...
/**
 * Servlet implementation class AdicionaTipoBeacon
 */
@WebServlet("/adicionatipobeacon")
public class AdicionaTipoBeacon extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdicionaTipoBeacon() {
        super();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        res.sendRedirect("tipobeacon.jsp");
	}
